...
//we need to instantiate this REmoteLRS object then sendrequet can be called from it with 'this', somehow
...
/////////////This is my new function
   public function createTenant($urlToSend){ 
        ...
        $statements = "";
          ...
          //  }
           ...
           $response = $lets->sendRequest('POST', $url, $requestCfg);
    ...
    /// @param $resource - ??
    /// @param $tenantName - what you want the tenant to be named
    ///changed their func to createTenant, lets see if it works
    private function sendRequest($method, $resource) {
        ...
        //
        $url = $resource;
       //not sure what this is for, I am going to put whole http addy in mine
       //AH - "Searches subject for a match to the regular expression given in pattern."
